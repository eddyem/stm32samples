...
int linerdy = 0,        // received data ready
    ...
    txdlen = 0          // length of transmitted data
;

static int  rbufno = 0, // current rbuf number
            txnum = 0;  // current number of transmitted symbol in tbuf
...
void USART1_config(){
    ...
    USART1->CR1 |= USART_CR1_TCIE | USART_CR1_TXEIE | USART_CR1_RXNEIE;/* enable TC, TXE & RXNE interrupt */
    /* Configure IT */
