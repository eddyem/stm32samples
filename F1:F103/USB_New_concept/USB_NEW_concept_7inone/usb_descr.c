...
_USB_STRING_(ID1, u"usb_cdcA");
_USB_STRING_(ID2, u"usb_cdcB");
_USB_STRING_(ID3, u"usb_cdcC");
_USB_STRING_(ID4, u"usb_cdcD");
_USB_STRING_(ID5, u"usb_cdcE");
_USB_STRING_(ID6, u"usb_cdcF");
_USB_STRING_(ID7, u"usb_cdcG");
...
static const void* const StringDescriptor[iDESCR_AMOUNT] = {
    ...
    [iINTERFACE_DESCR4] = &ID4,
    [iINTERFACE_DESCR5] = &ID5,
    [iINTERFACE_DESCR6] = &ID6,
    [iINTERFACE_DESCR7] = &ID7,
};
